...
h1 align="center">
  <img src="https://github.com/Lykon3/assets/blob/main/banner.gif" alt="Digital Mystery School Banner" width="100%">
</h1>
...
- Creator of the [PROMIS Cathedral](https://github.com/Lykon3/myth-engine-promis-cathedral)
...
| Case | Type | Link |
|------|------|------|
| ILSI vs Scientific Integrity | PDF Report | [Read Here](https://github.com/Lykon3/assets/blob/main/CocaCola_ILSI_Combined_Report.pdf) |
| Coca-Cola: Empire of Influence | PDF Report | [Standalone](https://github.com/Lykon3/assets/blob/main/Coca-Cola_History_and_Controversies.pdf) |
...
> “Bound by story. Empowered by symbol.”
...
### 2. **Assets to Upload**
Upload these to your `assets` repo (or any public repo):
- `banner.gif` (your aesthetic header image)
- `sigil_of_the_month.png` (any rotating artwork or mystery sigil)
- `CocaCola_ILSI_Combined_Report.pdf`


**Enter the temple. Shape your own symbols. Teach nothing, reveal everything.**
